<template>
  <el-dialog
    ...
    <el-form-item label="ÊôÐÔ·Ö×éid" prop="attrGroupId">
      <el-input v-model="dataForm.attrGroupId" placeholder="ÊôÐÔ·Ö×éid"></el-input>
    </el-form-item>
    <el-form-item label="ÊôÐÔ×éÄÚÅÅÐò" prop="attrSort">
      <el-input v-model="dataForm.attrSort" placeholder="ÊôÐÔ×éÄÚÅÅÐò"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          attrGroupId: [
            { required: true, message: 'ÊôÐÔ·Ö×éid不能为空', trigger: 'blur' }
          ],
          attrSort: [
            { required: true, message: 'ÊôÐÔ×éÄÚÅÅÐò不能为空', trigger: 'blur' }
          ]
        }
      }
    },
