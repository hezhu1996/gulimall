<template>
  <el-dialog
    ...
    <el-form-item label="ÆÀÂÛid" prop="commentId">
      <el-input v-model="dataForm.commentId" placeholder="ÆÀÂÛid"></el-input>
    </el-form-item>
    <el-form-item label="»Ø¸´id" prop="replyId">
      <el-input v-model="dataForm.replyId" placeholder="»Ø¸´id"></el-input>
    </el-form-item>
    </el-form>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          commentId: [
            { required: true, message: 'ÆÀÂÛid不能为空', trigger: 'blur' }
          ],
          replyId: [
            { required: true, message: '»Ø¸´id不能为空', trigger: 'blur' }
          ]
        }
      }
    },
