<template>
  <el-dialog
    ...
    <el-form-item label="ÍË»õÔ­ÒòÃû" prop="name">
      <el-input v-model="dataForm.name" placeholder="ÍË»õÔ­ÒòÃû"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          name: [
            { required: true, message: 'ÍË»õÔ­ÒòÃû不能为空', trigger: 'blur' }
          ],
          sort: [
