  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="·¢»õºó×Ô¶¯È·ÈÏÊÕ»õÊ±¼ä£¨Ìì£©">
      </el-table-column>
      <el-table-column
        prop="finishOvertime"
        header-align="center"
        align="center"
        label="×Ô¶¯Íê³É½»Ò×Ê±¼ä£¬²»ÄÜÉêÇëÍË»õ£¨Ìì£©">
      </el-table-column>
      <el-table-column
        prop="commentOvertime"
        header-align="center"
        align="center"
        label="¶©µ¥Íê³Éºó×Ô¶¯ºÃÆÀÊ±¼ä£¨Ìì£©">
      </el-table-column>
      <el-table-column
        prop="memberLevel"
        header-align="center"
        align="center"
        label="»áÔ±µÈ¼¶¡¾0-²»ÏÞ»áÔ±µÈ¼¶£¬È«²¿Í¨ÓÃ£»ÆäËû-¶ÔÓ¦µÄÆäËû»áÔ±µÈ¼¶¡¿">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
