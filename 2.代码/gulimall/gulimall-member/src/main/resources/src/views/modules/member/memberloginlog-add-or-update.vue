<template>
  <el-dialog
    ...
    <el-form-item label="µÇÂ¼ÀàÐÍ[1-web£¬2-app]" prop="loginType">
      <el-input v-model="dataForm.loginType" placeholder="µÇÂ¼ÀàÐÍ[1-web£¬2-app]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          loginType: [
            { required: true, message: 'µÇÂ¼ÀàÐÍ[1-web£¬2-app]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
