<template>
  <el-dialog
    ...
    <el-form-item label="Âú¶àÉÙ" prop="fullPrice">
      <el-input v-model="dataForm.fullPrice" placeholder="Âú¶àÉÙ"></el-input>
    </el-form-item>
    <el-form-item label="¼õ¶àÉÙ" prop="reducePrice">
      <el-input v-model="dataForm.reducePrice" placeholder="¼õ¶àÉÙ"></el-input>
    </el-form-item>
    <el-form-item label="ÊÇ·ñ²ÎÓëÆäËûÓÅ»Ý" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="ÊÇ·ñ²ÎÓëÆäËûÓÅ»Ý"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          fullPrice: [
            { required: true, message: 'Âú¶àÉÙ不能为空', trigger: 'blur' }
          ],
          reducePrice: [
            { required: true, message: '¼õ¶àÉÙ不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: 'ÊÇ·ñ²ÎÓëÆäËûÓÅ»Ý不能为空', trigger: 'blur' }
          ]
        }
      }
    },
